...
public class Join_InsertUserData {
    public void JoinInsertUserdata(String id, String pw, String name, String birth, String prof, String local, String purp, String imgurl) {
        ...
        class insertD extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                try {
                    ...
                    // String strUrl = "http://hiseungjun2.cafe24.com/report_project/JSONUserInsert.jsp";
                    String strUrl = "http://tmdwns9738.cafe24.com/report_project/JSONUserInsert.jsp";
