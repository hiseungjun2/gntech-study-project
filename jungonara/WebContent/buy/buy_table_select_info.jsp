        ...
        <div id="basic_table">
            <div class="container-body">
				...
				<%
					...
					buyDto buyDto = (buyDto)request.getAttribute("buyselectlistinfo");
				...
				<div class="comment">
					<form action="./buycommentinsert" method="post">
						...
						<input type="hidden" value="select" name="info">
...
$(document).ready(function() {
	$("#back").click(function() {
		...
		$(location).attr("href", "/jungonara/buyselectinfo?num="+current);
	})
	$("#next").click(function() {
		var current = Number($("h3").attr('id'))+1;
		$(location).attr("href", "/jungonara/buyselectinfo?num="+current);
